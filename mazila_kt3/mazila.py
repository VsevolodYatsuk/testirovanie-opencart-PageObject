...
def main():
    ...
    page.input_text(By.XPATH, "//input[@id='register_email']", "sevateti2@yandex.com")
    page.input_text(By.XPATH, "//input[@id='register_password']", "ctdf20051906")
    page.input_text(By.XPATH, "//input[@id='register_confirm_password']", "ctdf20051906")
    page.input_text(By.XPATH, "//input[@id='register_firstname']", "Vsevolod")
    page.input_text(By.XPATH, "//input[@id='register_lastname']", "Yatsuk")
    page.input_text(By.XPATH, "//input[@id='register_telephone']", "79779368202")
